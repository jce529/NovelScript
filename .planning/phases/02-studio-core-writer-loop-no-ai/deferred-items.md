...
- **`app/layout.tsx(20,50): error TS2304: Cannot find name 'LayoutProps'.`**
  ...
  to any file touched by Plan 02-02. Likely caused by a missing/stale `next-env.d.ts` or
  Next.js 16 typed-routes codegen not having run in this worktree. Out of scope for this
  plan's task boundary (root layout, not touched by works/studio work). Revisit if a future
