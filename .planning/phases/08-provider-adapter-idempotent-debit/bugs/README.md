...
**Phase 8 회귀는 없다.** 발견된 문제는 대부분 이전 phase에서 생긴 것이고, BUG-04만 Phase 8에서 정해야 할 과금 정책 문제다.
...
| [BUG-04](BUG-04-thinking-tokens-not-debited.md) | Gemini 사고(thinking) 토큰이 지갑 차감에서 빠짐 | Medium (과금) | 08 | 해당 없음 (정책 미결) | 결정 대기 |
